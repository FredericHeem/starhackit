...
const Google = props => (
<Svg width={props.width || 18} height={props.height || 18} viewBox="0 0 18 18"><G fill="none" fill-rule="evenodd"><Path fill="#4285F4" d="M17.64 9.205c0-.639-.057-1.252-.164-1.841H9v3.481h4.844a4.14 4.14 0 0 1-1.796 2.716v2.259h2.908c1.702-1.567 2.684-3.875 2.684-6.615z"></Path>
